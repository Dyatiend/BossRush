    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                UNITY_DEFINE_INSTANCED_PROP( float, _Glow_Intensity)
...
////// Emissive:
                ...
                float _Glow_Intensity_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Glow_Intensity );
                float3 emissive = (node_5999.rgb*i.vertexColor.rgb*i.vertexColor.a*_Glow_Intensity_var);
